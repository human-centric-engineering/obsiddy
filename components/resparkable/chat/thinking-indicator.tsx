 ...
 * this. Importing it would couple a framework-tier component to a Resparkable-owned
 * admin module, which is the coupling this tier exists to avoid — a Resparkable
 * upgrade that moves or renames that file would break Resparkable inside a host
 ...
 * or a *rendering*. `parseChatStreamEvent` is imported by `resparkable-chat.tsx`

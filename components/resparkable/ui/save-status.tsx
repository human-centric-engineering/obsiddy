 ...
 *
 * Sunrise ships no toast primitive and Resparkable deliberately does not add one
 ...
 * toast is the wrong shape for this UI anyway: Resparkable's writes are small,
...
/**
 * The state machine every Resparkable mutation uses, so the pattern is written once.
 *

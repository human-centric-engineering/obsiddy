 ...
 *
 * Resparkable has no skeleton primitive and `plan.md` §9 says build rather than
 * install. These exist so every Resparkable `loading.tsx` looks like the page it is
...
/** The shape most Resparkable surfaces are: a heading, then a stack of rows. */

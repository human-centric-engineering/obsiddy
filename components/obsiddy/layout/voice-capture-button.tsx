 ...
 *
 * Same reason `<ObsiddyChat>` is not `<ChatInterface>`: that component takes a
 ...
 * Adding an "optional agent" mode to a Sunrise-owned component would be editing a
...
export function VoiceCaptureButton({
  ...
  const handleClick = React.useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(OBSIDDY_API.TRANSCRIBE, { method: 'POST', body: form });
    ...
    <div className="relative inline-flex shrink-0">
      ...
      {isRecording && (
        ...
        <div
          ...
          role="status"
          aria-live="polite"
          data-testid="obsiddy-recording-indicator"
        >

 ...
 *
 * Everything here comes from **one** `/obsiddy/today` fetch: ranked tasks with
              ...
              action={
                payload.inboxCount > 0 ? (
                  <Button asChild size="sm">
                    <Link href={OBSIDDY_ROUTES.INBOX}>Go to the inbox</Link>
                  </Button>
                ) : undefined
              }
            />
          ...
          <CardContent>
            {payload.timeBlocks.length === 0 ? (
              <p className="text-muted-foreground text-xs">
                Nothing blocked out.{' '}
                <Link href={OBSIDDY_ROUTES.PLAN} className="underline">
                  Plan your day
                </Link>{' '}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            {payload.inboxCount > 0 && (
              <Button asChild size="sm" variant="outline">
                <Link href={OBSIDDY_ROUTES.INBOX}>Triage them</Link>
              </Button>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            {payload.unreviewedLinks.count > 0 && (
              <Button asChild size="sm" variant="outline">
                <Link href={OBSIDDY_ROUTES.CONNECTIONS}>Review them</Link>
              </Button>
            )}
          </CardContent>
        </Card>

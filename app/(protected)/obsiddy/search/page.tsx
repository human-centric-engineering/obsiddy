...
import { SearchControls } from '@/components/obsiddy/search/search-controls';
...
import { searchHitsSchema } from '@/lib/framework/obsiddy/ui/payloads';
 ...
 */
export default async function ObsiddySearchPage({
  searchParams,
}: {
  ...
  const result = await readObsiddy(`${OBSIDDY_API.SEARCH}?${search.toString()}`, searchHitsSchema);

...
import { inboxPayloadSchema, projectSchema } from '@/lib/framework/obsiddy/ui/payloads';
 ...
 */
export default async function ObsiddyInboxPage() {
  const [inbox, projects] = await Promise.all([
    readObsiddy(OBSIDDY_API.INBOX, inboxPayloadSchema),

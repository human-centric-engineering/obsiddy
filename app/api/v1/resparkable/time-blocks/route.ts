/**
 * GET  /api/v1/resparkable/time-blocks — list (owner-scoped, archived excluded by default)
 * POST /api/v1/resparkable/time-blocks — create
 *
...
export const { GET, POST } = createCollectionHandlers(timeBlockResource);

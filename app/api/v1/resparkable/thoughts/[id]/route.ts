/**
 * GET    /api/v1/resparkable/thoughts/:id — read one
 * PATCH  /api/v1/resparkable/thoughts/:id — update
 * DELETE /api/v1/resparkable/thoughts/:id — archive (`?permanent=true` destroys)
 *

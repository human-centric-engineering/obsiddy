/**
 * GET    /api/v1/resparkable/areas/:id — read one
 * PATCH  /api/v1/resparkable/areas/:id — update
 * DELETE /api/v1/resparkable/areas/:id — archive (`?permanent=true` destroys)
 *
...
export const { GET, PATCH, DELETE } = createItemHandlers(areaResource);

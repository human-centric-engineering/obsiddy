/**
 * GET    /api/v1/resparkable/projects/:id — read one
 * PATCH  /api/v1/resparkable/projects/:id — update
 * DELETE /api/v1/resparkable/projects/:id — archive (`?permanent=true` destroys)
 *

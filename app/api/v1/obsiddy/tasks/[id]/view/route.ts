/**
 * GET /api/v1/obsiddy/tasks/[id]/view — one task, with its context.
 *
...
import { buildTaskView } from '@/lib/framework/obsiddy/services/details';
...
export const GET = withAuth<{ id: string }>(async (request, session, { params }) => {
  ...
  log.info('Obsiddy task view', { related: payload.related.length });

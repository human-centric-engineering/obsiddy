/**
 * GET /api/v1/obsiddy/boards/[id]/export?format=csv|json
 *
...
import { boardExportQuerySchema } from '@/lib/framework/obsiddy/validations';
...
export const GET = withAuth<{ id: string }>(async (request, session, { params }) => {
  ...
  log.info('Obsiddy board exported', { format: query.format, cards: view.totalCards });

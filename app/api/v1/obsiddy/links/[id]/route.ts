/**
 * PATCH /api/v1/obsiddy/links/[id] — review a suggested connection.
 *
...
import { reviewLink } from '@/lib/framework/obsiddy/repo/links';
import { ownerScope } from '@/lib/framework/obsiddy/repo/owner-scope';
import { updateLinkSchema } from '@/lib/framework/obsiddy/validations';
...
export const PATCH = withAuth<{ id: string }>(async (request, session, { params }) => {
  ...
  log.info('Obsiddy link reviewed', { id, status: link.status });

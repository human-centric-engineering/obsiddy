-- Resparkable phase 7 — the across-users cursor for the connection sweep job.
--
...
ALTER TABLE "framework_resparkable_space" ADD COLUMN "lastSweptAt" TIMESTAMP(3);

CREATE INDEX "framework_resparkable_space_lastSweptAt_idx" ON "framework_resparkable_space"("lastSweptAt");

 ...
 * done this week" in the weekly review, which reads `ObsiddyEvent` rather than
 ...
 *
 * @see lib/framework/obsiddy/services/capture.ts
 */

import { describe, it, expect, beforeEach, vi } from 'vitest';

vi.mock('@/lib/framework/obsiddy/repo/thoughts', () => ({ captureThought: vi.fn() }));

...
import { assembleVaultFiles, type CollectedNote } from '@/lib/framework/obsiddy/vault/export';
import {
  buildImportPlan,
  normaliseTitle,
  type ExistingNote,
...
import { buildVaultZip, readVaultZip } from '@/lib/framework/obsiddy/vault/zip';
  ...
  },
  {
    ...
    note: encodeProject(
      ...
      },
      {
        ...
        links: [
          { targetTitle: 'Ship Obsiddy', kind: 'supports', strength: 0.71, rationale: 'Same push' },
        ],
      }
    ),
  },

 ...
 *   with a shrug.
 *
 * @see components/obsiddy/layout/capture-attachment.tsx
 */
...
vi.mock('@/components/obsiddy/documents/upload-request', () => ({
  uploadDocument: vi.fn(),
}));

import { AttachmentCard } from '@/components/obsiddy/layout/capture-attachment';
...
describe('AttachmentCard', () => {
  ...
  it('reads text through the extract endpoint, which stores nothing', async () => {
    ...
    expect(fetchSpy.mock.calls[0]?.[0]).toBe('/api/v1/obsiddy/documents/extract');

 ...
 *
 * @see components/obsiddy/entities/entities-view.tsx
 */
...
describe('EntitiesView', () => {
  ...
  it('archives the row that was clicked', async () => {
    ...
    await waitFor(() => {
      expect(mockedDelete).toHaveBeenCalledWith('/api/v1/obsiddy/entities/ent_2');
    });
    // Never the neighbouring row.
    expect(mockedDelete).not.toHaveBeenCalledWith('/api/v1/obsiddy/entities/ent_1');
  });
  ...
  it('restores an archived entity', async () => {
    ...
    await waitFor(() => {
      expect(mockedPost).toHaveBeenCalledWith('/api/v1/obsiddy/entities/ent_1/restore');
    });
  });

 ...
 *
 * @see components/obsiddy/lifecycle/stale-digest.tsx
 */
...
import type { StaleDigestWire } from '@/lib/framework/obsiddy/ui/payloads';
...
describe('StaleDigest', () => {
  ...
  it('posts the type and id when the user says it is still live', async () => {
    ...
    await waitFor(() => {
      expect(mockedPost).toHaveBeenCalledWith('/api/v1/obsiddy/stale/still-live', {

 ...
 * A column IS a task status (`ObsiddyTask.status`), so the checkbox set the user
 ...
 *   already picked
 *
 * @see components/obsiddy/board/board-form.tsx
 */
...
import type { BoardWire, ProjectWire } from '@/lib/framework/obsiddy/ui/payloads';

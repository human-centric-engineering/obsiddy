/**
 * Unit Tests: `GET /api/v1/obsiddy/counts`.
 *
 * This endpoint exists so the Obsiddy shell — which renders on every one of its
 ...
 * asserted in `tests/unit/lib/framework/obsiddy/services/counts.test.ts`.
 *
 * @see app/api/v1/obsiddy/counts/route.ts
 */
...
import { GET } from '@/app/api/v1/obsiddy/counts/route';
...
function req(headers: Record<string, string> = {}) {
  return {
    url: 'http://localhost:3000/api/v1/obsiddy/counts',
...
describe('GET /api/v1/obsiddy/counts', () => {

 ...
 *
 *   POST /api/v1/obsiddy/documents/extract
 *   POST /api/v1/obsiddy/transcribe
 *
 ...
 *
 * @see app/api/v1/obsiddy/documents/extract/route.ts
 * @see app/api/v1/obsiddy/transcribe/route.ts
 */
...
import { POST as EXTRACT_POST } from '@/app/api/v1/obsiddy/documents/extract/route';
import { POST as TRANSCRIBE_POST } from '@/app/api/v1/obsiddy/transcribe/route';
import { getRouteLogger } from '@/lib/api/context';
import { prisma } from '@/lib/db/client';
import { ingestDocument, resolveIngestPolicy } from '@/lib/framework/obsiddy/documents/ingest';
...
describe('POST /api/v1/obsiddy/documents/extract', () => {
  it('returns the text and stores nothing', async () => {
    ...
    const { request } = multipartRequest('http://x/api/v1/obsiddy/documents/extract', {
  ...
  it('rejects an oversize body BEFORE materialising it', async () => {
    ...
    const { request } = multipartRequest(
      'http://x/api/v1/obsiddy/documents/extract',
...
describe('POST /api/v1/obsiddy/transcribe', () => {
  ...
  it('rejects a non-audio upload', async () => {
    const { request } = multipartRequest('http://x/api/v1/obsiddy/transcribe', {

 ...
 *
 * @see app/api/v1/obsiddy/tasks/[id]/snooze/route.ts
 */
...
import { POST as PROJECT_SNOOZE } from '@/app/api/v1/obsiddy/projects/[id]/snooze/route';
import { POST as PROJECT_UNSNOOZE } from '@/app/api/v1/obsiddy/projects/[id]/unsnooze/route';
import { POST as TASK_SNOOZE } from '@/app/api/v1/obsiddy/tasks/[id]/snooze/route';
import { POST as TASK_UNSNOOZE } from '@/app/api/v1/obsiddy/tasks/[id]/unsnooze/route';
import { POST as THOUGHT_SNOOZE } from '@/app/api/v1/obsiddy/thoughts/[id]/snooze/route';
import { POST as THOUGHT_UNSNOOZE } from '@/app/api/v1/obsiddy/thoughts/[id]/unsnooze/route';
...
function req(body?: unknown) {
  return {
    url: 'http://x/api/v1/obsiddy/tasks/id_1/snooze',
    json: async () => body,

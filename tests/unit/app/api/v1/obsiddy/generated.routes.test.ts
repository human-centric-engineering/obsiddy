 ...
 *
 * `app/api/v1/obsiddy/boards/route.ts`, `.../boards/[id]/route.ts`,
 ...
 * versa.
 *
 * @see app/api/v1/obsiddy/boards/route.ts
 * @see app/api/v1/obsiddy/boards/[id]/route.ts
 * @see app/api/v1/obsiddy/boards/[id]/restore/route.ts
 * @see app/api/v1/obsiddy/tags/route.ts
 * @see app/api/v1/obsiddy/tags/[id]/route.ts
 * @see lib/framework/obsiddy/api/handlers.ts
 */

import { describe, it, expect, vi } from 'vitest';

vi.mock('@/lib/framework/obsiddy/api/handlers', () => ({
...
import { boardResource, tagResource } from '@/lib/framework/obsiddy/services/resources';
...
describe('GET/POST /api/v1/obsiddy/boards', () => {
  it('wires GET and POST from createCollectionHandlers(boardResource)', async () => {
    const route = await import('@/app/api/v1/obsiddy/boards/route');
...
describe('GET/PATCH/DELETE /api/v1/obsiddy/boards/[id]', () => {
  it('wires GET, PATCH and DELETE from createItemHandlers(boardResource)', async () => {
    const route = await import('@/app/api/v1/obsiddy/boards/[id]/route');
...
describe('POST /api/v1/obsiddy/boards/[id]/restore', () => {
  it('wires POST from createRestoreHandler(boardResource)', async () => {
    const route = await import('@/app/api/v1/obsiddy/boards/[id]/restore/route');
...
describe('GET/POST /api/v1/obsiddy/tags', () => {
  it('wires GET and POST from createCollectionHandlers(tagResource)', async () => {
    const route = await import('@/app/api/v1/obsiddy/tags/route');
...
describe('GET/PATCH/DELETE /api/v1/obsiddy/tags/[id]', () => {
  it('wires GET, PATCH and DELETE from createItemHandlers(tagResource)', async () => {
    const route = await import('@/app/api/v1/obsiddy/tags/[id]/route');

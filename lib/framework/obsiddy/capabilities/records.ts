...
import { runUpsert, type UpsertData } from '@/lib/framework/obsiddy/capabilities/upsert';
...
const projectSpec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.upsertProject);

export class ObsiddyUpsertProjectCapability extends ObsiddyCapability<
...
const goalSpec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.upsertGoal);

export class ObsiddyUpsertGoalCapability extends ObsiddyCapability<
...
const entitySpec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.upsertEntity);

export class ObsiddyUpsertEntityCapability extends ObsiddyCapability<

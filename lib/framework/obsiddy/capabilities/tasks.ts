/**
 * The two task capabilities: `obsiddy_list_tasks` and `obsiddy_upsert_task`.
 *
...
const listSpec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.listTasks);
...
export class ObsiddyListTasksCapability extends ObsiddyCapability<
  AgentListTasksInput,
  ListTasksData
> {
...
const upsertSpec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.upsertTask);

export class ObsiddyUpsertTaskCapability extends ObsiddyCapability<

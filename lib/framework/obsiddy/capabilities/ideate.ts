/**
 * `obsiddy_ideate` — the deliberate counterpart to the passive sweep.
 *
...
import { ideateSchema, type IdeateInput } from '@/lib/framework/obsiddy/validations';
...
const spec = obsiddyCapabilitySpec(OBSIDDY_CAPABILITY_SLUGS.ideate);
...
export class ObsiddyIdeateCapability extends ObsiddyCapability<IdeateInput, IdeateData> {
   ...
   * the requested count, and how many framings came back. `obsiddy_ideate` is

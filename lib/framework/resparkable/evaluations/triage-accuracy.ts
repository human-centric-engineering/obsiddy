/**
 * `resparkable_triage_accuracy` — did triage file this the way you would have?
 *
 ...
 * sunrise#462 was about. So registering this from `initResparkable()` would put it
 ...
 * #33 in `.context/framework/resparkable/sunrise-asks.md`. Until it lands, the
 * runner script registers this itself and grades in-process — see
 * `scripts/framework/resparkable/eval-triage.ts`.
 */
...
export const RESPARKABLE_TRIAGE_ACCURACY_SLUG = 'resparkable_triage_accuracy';
...
export const resparkableTriageAccuracyGrader: Grader<Config> = {
  slug: RESPARKABLE_TRIAGE_ACCURACY_SLUG,
  family: 'heuristic',
 ...
 */
export function registerResparkableGraders(): void {
  registerGrader(resparkableTriageAccuracyGrader);
}

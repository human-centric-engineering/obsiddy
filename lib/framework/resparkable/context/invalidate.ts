 ...
 *
 * **It is called from `recordResparkableEvent`, not from each service.** Every
 ...
 */
export function invalidateResparkableContext(userId: string): void {
  invalidateContext(RESPARKABLE_CONTEXT_TYPE, userId, { userId });
}

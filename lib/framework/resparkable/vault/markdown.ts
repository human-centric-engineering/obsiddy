 ...
 * parses as a body with no frontmatter, loses its `resparkable-id`, and imports as a
 ...
 * `resparkable-id` and `resparkable-type` lead every file and a human opening one in a

 ...
 *
 * @see lib/framework/resparkable/vault/markdown.ts — the frontmatter codec
 * @see lib/framework/resparkable/vault/notes.ts — what each type encodes to
 * @see .context/framework/resparkable/plan.md §14
 */
...
/** Resparkable's own corner of the vault — manifest, and later conflicts and trash. */

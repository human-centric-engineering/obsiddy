/**
 * Resparkable's admin-sidebar contribution.
 *
 ...
 *
 * The section title is "Resparkable" rather than something generic: the registry keys
 * sections by title, and the four core Resparkable titles ("Overview", "Management",
...
/**
 * Register the Resparkable admin section.
 *
 ...
 */
export function registerResparkableAdminNav(): void {
  registerNavSection({
    title: 'Resparkable',
    items: [
      {
        href: '/admin/resparkable/settings',
        label: 'Settings',
        icon: Brain,

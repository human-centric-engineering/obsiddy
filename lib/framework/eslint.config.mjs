...
const prismaBan = {
  ...
  message:
    'Only lib/framework/obsiddy/repo/** may reach the database. Add a repo function that takes an ' +
...
export default [
  // ── Framework-tier import boundary ───────────────────────────────────────
  {
    ...
    ignores: ['lib/framework/obsiddy/repo/**', 'lib/framework/obsiddy/db-drift.ts'],
    rules: {
  ...
  {
    files: ['lib/framework/obsiddy/repo/**/*.ts', 'lib/framework/obsiddy/db-drift.ts'],
    rules: {
